<template>
  <div class="pokedex">
    <div style="width: 100%; margin-top: 40px; display: inline-block;" class="PokemonLogo">
            <div style="display: inline-block; margin: 0px auto; width: 100%;">
                <v-img :width="400" aspect-ratio="16/9" cover
                    src="https://static.vecteezy.com/system/resources/previews/027/127/591/original/pokemon-logo-pokemon-icon-transparent-free-png.png"></v-img>
            </div>
        </div>
